...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('ewe7d8c7PB', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('LE8uYvD2Lw', 0, 'kyHKu-137pOWc57yISmQun', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '192.168.2.250', 'port' => NULL, 'dbname' => 'inprink', 'user' => 'root', 'password' => 'nacella', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_57b98950b0335d50d0eb611ca4c59befe5779f6a2bff128fb02e529b6d82ba5f');
    ...
    {
        return $this->services['property_accessor'] = new \Symfony\Component\PropertyAccess\PropertyAccessor(false, false, \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('4qEhpbsl86', NULL, 'kyHKu-137pOWc57yISmQun', $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $instance->setHost('192.168.2.250');
        $instance->setPort(25);
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('fa750757d1818edc1c3faece6f262d7953ebfab0');
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('E9T2qbC9Kk', 0, 'kyHKu-137pOWc57yISmQun', (__DIR__.'/pools'), $this->get('monolog.logger.cache'));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('58b05d929ac158.01738249')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_host' => '192.168.2.250',
            'database_port' => NULL,
            'database_name' => 'inprink',
            'database_user' => 'root',
            'database_password' => 'nacella',
            'mailer_transport' => 'smtp',
            'mailer_host' => '192.168.2.250',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => 'fa750757d1818edc1c3faece6f262d7953ebfab0',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'fa750757d1818edc1c3faece6f262d7953ebfab0',
            ...
            'swiftmailer.mailer.default.transport.smtp.host' => '192.168.2.250',
